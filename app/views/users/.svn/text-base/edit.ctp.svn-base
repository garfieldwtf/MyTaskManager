...
<?php echo $form->create('User');?>
	...
	<?php
		echo $form->input('id');
		echo $form->input('username',array('readonly'=>'readonly','class'=>'readonly'));  
        ...
        echo $form->input('title_id',array('type' => 'select', 'empty' => '--please select--'));
    ...
    <?php
        ...
        if(empty($curgroup)){
            ...
            echo $curLink->back($html->link(sprintf(__('Go Back to "%s"', true),sprintf(__('%s List',true),__('Membership',true))),array('controller'=>'memberships','action'=>'index')));
        }
        echo $form->end();
    ?>
</div>
